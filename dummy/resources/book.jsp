...
<c:if test="${!empty bookList}">
    ...
    <tbody>
        <tr>
		<td >
				<display:table name="bookList" id="book" class="table" pagesize="50" requestURI="">
				  <display:column property="book_name" escapeXml="true" sortable="true"></display:column>
				  <display:column property="author" escapeXml="true" sortable="true"></display:column>
				</display:table>
			</td>
		</tr>
	</tbody> -->
